...
const catalog: CatalogClient = new CatalogClient(import.meta.env.VITE_LIBRARY_API_BASE ?? 'https://library.jmonkeyengine.org/');
const generator: InitializerZipService = new InitializerZipService(new URL('./template.zip', document.baseURI));
